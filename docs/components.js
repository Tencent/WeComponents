module.exports = [
    ...
    },
    {
        ...
        "props": {
            ...
            "pagination": {
                "description": "分页组件类型，若设置，则表格展示分页组件\n可选值：default, simple（不展示首尾页/跳转按钮）",
                "tags": {
                    "property": [
                        {
                            "title": "property",
    ...
    },
    {
        ...
        "methods": [
            ...
            },
            {
                ...
                "modifiers": [],
                "description": "Text组件mouseenter事件\n<event>onTextMouseEnter</event>\n\n<customParam>\n type{string}  事件名称;\n data{string/number}  当前组件数据;\n target{Object} 触发事件的组件的vm实例;\n nativeEvent{object} 原生事件对象\n</cutomParam>",
                "tags": {
                    "access": [
                        {
                            "description": "public",
            ...
            },
            {
                ...
                "modifiers": [],
                "description": "Text组件mouseleave事件\n<event>onTextMouseLeave</event>\n\n<customParam>\n type{string}  事件名称;\n data{string/number}  当前组件数据;\n target{Object} 触发事件的组件的vm实例;\n nativeEvent{object} 原生事件对象\n</cutomParam>",
                "tags": {
                    "access": [
                        {
                            "description": "public",
